<x-filament-panels::page>
    <div x-data="{
        ...
        successCallback(position) {
            ...
            if (this.pageWire) {
                this.pageWire.set('latitude', lat);
                this.pageWire.set('longitude', lng);
                this.pageWire.set('locationError', null);
            }
        },
        errorCallback(error) {
            ...
            if (this.pageWire) {
                this.pageWire.set('locationError', msg);
            }
        },
        gpsAndAction(action) {
            ...
            if (this.pageWire) {
                this.pageWire.call(action, this.latitude, this.longitude);
            }
        }
