            ...
            <div>
                ...
                <div class="mt-1">
                    ...
                    <a href="{{ asset('/' . $record->resume) }}"
                        target="_blank"
                        class="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-dark bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 rounded-xl shadow-lg transition-all duration-300">
